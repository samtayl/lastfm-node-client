...
function createRequest(package, method, apiKey, params, sessionKey) {
	const request = Object.create(proto);

	Object.assign(request, params);
	
	request.method = package + "." + method;
...
proto.send = function(method, callback) {
