...
class LastFm {
	constructor(options = {}) {
		this.apiKey = (options && typeof options.apiKey === "string") ? options.apiKey : null;
		this.secret = (options && typeof options.secret === "string") ? options.secret : null;
		this.sessionKey = (options && typeof options.sessionKey === "string") ? options.sessionKey : null;
	}
