...
class LastFm {
	...
	chartGetTopTags(params, callback) {
		return request("chart", "getTopTags", this.apiKey, params).send(callback) || this;
	}
	...
	tagGetTopTags(callback) {
		return request("tag", "getTopTags", this.apiKey).send(callback) || this;
	}

	tagGetTopTracks(params, callback) {
		return request("tag", "getTopTracks", this.apiKey, params).send(callback) || this;
	}
	...
	trackAddTags(params, callback) {
		return request("track", "addTags", this.apiKey, params, this.sessionKey).sign(this.secret).send("POST", callback) || this;
	}
	...
	userGetFriends(params, callback) {
		return request("user", "getFriends", this.apiKey, params).send(callback) || this;
	}
