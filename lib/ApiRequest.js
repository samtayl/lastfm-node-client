...
class ApiRequest {
	 ...
	 * @param {string} apiPackage - API Package whose method to make a request to
	 * @param {string} apiMethod - API method to make a request to
	 * @param {string} apiKey - API key of an API account
	 * @param {Object} [params] - Paramaters to pass to API method
	 * @param {string} [sessionKey] - Session key of a user account
	 */
